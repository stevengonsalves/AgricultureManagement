	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				...
				<h2 style="font-weight: bold;" >VegManagment</h2>
				<p style="font-weight: bold ;" >Your Product Our Market</p>
				<br><br>
				<center>
					<div>
						<div class="6u 12u$(xsmall)">
							<button class="button fit" onclick="document.getElementById('id01').style.display='block'" style="width:auto;background-color:green; border-radius:25px">LOGIN</button>
						</div>

						<div class="6u 12u$(xsmall)">
							<button class="button fit" onclick="document.getElementById('id02').style.display='block'" style="width:auto;background-color:green; border-radius:25px">REGISTER</button>
						</div>
					</div>
				</center>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">VegManagment &copy; </h3>
			<div class="logo">
		...
		<div class="footer-center">
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:VegManagent@gmail.com" style="color:white">demo@demo.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About VegManagment</b></span>
				VegManagment is e-commerce trading platform for grains & grocerries...
			</p>
